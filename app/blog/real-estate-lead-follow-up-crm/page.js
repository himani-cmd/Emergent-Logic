        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none mt-8">
              ...
              <p>
                We also documented this as a <Link href="/case-studies/real-estate-lead-routing-long-cycle-nurture" className="text-orange-700 hover:underline">representative real estate lead routing pattern</Link>, showing how buyer, seller, valuation, referral, and long-cycle leads can move through CRM ownership and follow-up views.
              </p>
