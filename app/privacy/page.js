  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl prose prose-lg">
        ...
        <p className="text-gray-600 mb-6">When you visit our website or use our services, we may collect personal information such as your name, email address, phone number, and company name when you submit our contact form or book a strategy call through Calendly. If you choose the AI voice consultation, the service processes the audio and conversation content needed to respond and may prepare a concise consultation summary in your browser.</p>
