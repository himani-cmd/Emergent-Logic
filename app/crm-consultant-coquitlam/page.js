...
export const metadata = {
  ...
  description: 'CRM consulting in Coquitlam BC. Salesforce, HubSpot, Zoho implementation. AI-accelerated delivery in 2-4 weeks. Free strategy call.',
  ...
  openGraph: {
    ...
    description: 'CRM consulting in Coquitlam BC. Salesforce, HubSpot, Zoho implementation. AI-accelerated delivery in 2-4 weeks.',
...
const faqs = [
  ...
  { q: 'How much does CRM consulting cost in Coquitlam?', a: "Emergent Logic's CRM implementations start from $1,500 for basic setups. Our AI-accelerated methodology costs 40-60% less than traditional consulting firms. Fixed pricing, no surprises." },
    ...
    <main className="min-h-screen">
      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-violet-900 via-indigo-900 to-purple-900">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">CRM Consultant in Coquitlam, BC</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Why Coquitlam businesses choose Emergent Logic</h2>
