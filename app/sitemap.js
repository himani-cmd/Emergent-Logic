export default function sitemap() {
  ...
  return [
    ...
    { url: `${baseUrl}/crm-consultant-abbotsford`, lastModified: currentDate, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${baseUrl}/crm-consultant-langley`, lastModified: currentDate, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${baseUrl}/crm-consultant-coquitlam`, lastModified: currentDate, changeFrequency: 'monthly', priority: 0.9 },
