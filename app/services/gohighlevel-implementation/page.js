...
export const metadata = {
  title: 'GoHighLevel Consultant Canada | Implementation & Automation',
...
const jsonLd = { '@context': 'https://schema.org', '@graph': [
  { '@type': 'WebPage', '@id': `${canonical}#webpage`, url: canonical, name: 'GoHighLevel Implementation and Automation Support', description: metadata.description, dateModified: '2026-09-06', isPartOf: { '@id': 'https://www.emergent-logic.ca/#website' }, mainEntity: { '@id': `${canonical}#service` } },
...
function AssessmentCTA({ location }) {
  return <TrackedCTA ctaName={`GoHighLevel - Free CRM Workflow Assessment - ${location}`} destination="lead-follow-up-audit"><Link href="/lead-follow-up-audit" className="inline-flex min-h-12 max-w-full items-center justify-center gap-2 rounded-md bg-[#4B37C8] px-5 py-3 text-center font-semibold text-white hover:bg-[#38279D]">Request a Free CRM Workflow Assessment <ArrowRight className="h-5 w-5 flex-none" /></Link></TrackedCTA>;
}
  ...
  return <main className="min-h-screen bg-[#FBFBFF] text-[#101828]">
    ...
    <section className="bg-[#1E3A5F] pb-16 pt-28 text-white md:py-32">
      <div className="container mx-auto max-w-6xl px-4">
        <div className="[&_nav]:text-[#DFE3F5] [&_nav_span]:text-white"><Breadcrumbs items={[{label:'Services',href:'/services'},{label:'GoHighLevel Implementation',href:'/services/gohighlevel-implementation'}]} /></div>
        ...
        <p className="mt-4 text-sm text-[#CBD5E1]">Reviewed September 6, 2026 · No GoHighLevel certification or partner status claimed</p>
      </div>
    </section>
