        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-4">
            {[
              ...
              { title: 'No training plan or weak adoption strategy', desc: 'Installing a CRM is not the same as implementing it. Without structured onboarding and reinforcement, CRM adoption can decline after launch, weakening data quality and expected value. Training is not optional.' },
